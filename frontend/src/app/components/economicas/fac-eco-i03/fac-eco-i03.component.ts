...
import { FacEconomiaI03 } from 'src/app/models/fac-economia-i03';


@Component({
  selector: 'app-fac-eco-i03',
  templateUrl: './fac-eco-i03.component.html',
  styleUrls: ['./fac-eco-i03.component.css']
})
export class FacEcoI03Component implements OnInit {
  ...
  ngOnInit() {
    this.preload = true;
    this.service.getFacEconomiaI03()
          .subscribe(res=>{
             this.service.facEcoI03Array = res as FacEconomiaI03[];
             this.countAportes(); 
             this.preload = false;                
          });
  }
  ...
  countAportes(){
    const array = this.service.facEcoI03Array as FacEconomiaI03[];
    for(var _i = 0; _i < array.length; _i++){
        ...
        }else if(array[_i].TIPODEENTIDAD==="INSTITUCIONES DE EDUCACIÓN SUPERIOR"){
          if(array[_i].ANIOEJECUCION==="2014"){
