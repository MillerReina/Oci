...
import { FacEconomiaC02 } from 'src/app/models/fac-economia-c02';

@Component({
  selector: 'app-fac-eco-c02',
  templateUrl: './fac-eco-c02.component.html',
  styleUrls: ['./fac-eco-c02.component.css']
})
export class FacEcoC02Component implements OnInit {
  ...
  ngOnInit() {
    this.preload = true;
    this.service.getFacEconomiaC02()
          .subscribe(res=>{
              this.service.facEcoC02Array = res as FacEconomiaC02[];
              this.countData();
              this.preload = false;             
          });
  }
  ...
  countData(){
      const array = this.service.facEcoC02Array as FacEconomiaC02[];
