...
import { FacEconomiaI02 } from 'src/app/models/fac-economia-i02';

@Component({
  selector: 'app-fac-eco-i02',
  templateUrl: './fac-eco-i02.component.html',
  styleUrls: ['./fac-eco-i02.component.css']
})
export class FacEcoI02Component implements OnInit {
  ...
  ngOnInit() {
    this.preload = true;
    this.service.getFacEconomiaI02()
          .subscribe(res=>{
             this.service.facEcoI02Array = res as FacEconomiaI02[];
             this.countAportes();     
             this.preload = false;        
          });
  }
  ...
  countAportes(){
    const array = this.service.facEcoI02Array as FacEconomiaI02[];
