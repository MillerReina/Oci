...
import { FacEconomiaC01 } from 'src/app/models/fac-economia-c01';

@Component({
  selector: 'app-fac-eco-c01',
  templateUrl: './fac-eco-c01.component.html',
  styleUrls: ['./fac-eco-c01.component.css']
})
export class FacEcoC01Component implements OnInit {
  ...
  ngOnInit() {
    this.preload = true;
     this.service.getFacEconomiaC01()
          .subscribe(res=>{
              this.service.facEcoC01Array = res as FacEconomiaC01[];
              this.countData();              
              this.preload = false;
          });
  }
  ...
  countData(){
    const array = this.service.facEcoC01Array as FacEconomiaC01[];
