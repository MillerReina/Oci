...
import { FacEconomiaI01 } from 'src/app/models/fac-economia-i01';
@Component({
  selector: 'app-economicas',
  templateUrl: './economicas.component.html',
  styleUrls: ['./economicas.component.css']
})
export class EconomicasComponent implements OnInit {
  ...
  constructor(public zone : NgZone,public service : ServiceService) { 
    this.preload = true;
    this.service.getFacEconomiaI01()
          .subscribe(res=>{
             this.service.facEcoI01Array = res as FacEconomiaI01[];
             this.countAnios();
             this.preload = false;             
          });
  }
...
countAnios(){
    const array =  this.service.facEcoI01Array as FacEconomiaI01[];
