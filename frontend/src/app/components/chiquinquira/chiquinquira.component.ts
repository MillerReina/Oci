...
@Component({
  selector: 'app-chiquinquira',
  templateUrl: './chiquinquira.component.html',
  styleUrls: ['./chiquinquira.component.css']
})
export class ChiquinquiraComponent implements OnInit {
