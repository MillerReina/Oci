...
import { FacDerechoC02 } from 'src/app/models/fac-derecho-c02';

@Component({
  selector: 'app-fac-der-c02',
  templateUrl: './fac-der-c02.component.html',
  styleUrls: ['./fac-der-c02.component.css']
})
export class FacDerC02Component implements OnInit {
  ...
  ngOnInit() {
    this.preload = true;
    this.service.getFacDerechoC02()
          .subscribe(res=>{
              this.service.facDerC02Array = res as FacDerechoC02[];
              this.countData();
              this.preload = false;             
          });
  }
  ...
  countData(){
      const array = this.service.facDerC02Array as FacDerechoC02[];
