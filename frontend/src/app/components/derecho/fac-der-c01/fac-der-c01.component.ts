...
import { FacDerechoC01 } from 'src/app/models/fac-derecho-c01';

@Component({
  selector: 'app-fac-der-c01',
  templateUrl: './fac-der-c01.component.html',
  styleUrls: ['./fac-der-c01.component.css']
})
export class FacDerC01Component implements OnInit {
  ...
  ngOnInit() {
    this.preload = true;
     this.service.getFacDerechoC01()
          .subscribe(res=>{
              this.service.facDerC01Array = res as FacDerechoC01[];
              this.countData();              
              this.preload = false;
          });
  }
  ...
  countData(){
    const array = this.service.facDerC01Array as FacDerechoC01[];
