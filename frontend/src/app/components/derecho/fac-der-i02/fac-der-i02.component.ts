...
import { FacDerechoI02 } from 'src/app/models/fac-derecho-i02';

@Component({
  selector: 'app-fac-der-i02',
  templateUrl: './fac-der-i02.component.html',
  styleUrls: ['./fac-der-i02.component.css']
})
export class FacDerI02Component implements OnInit {
  ...
  ngOnInit() {
    this.preload = true;
    this.service.getFacDerechoI02()
          .subscribe(res=>{
             this.service.facDerI02Array = res as FacDerechoI02[];
             this.countAportes();
             this.preload = false;  
          });
  }
  countAportes(){
    const array = this.service.facDerI02Array as FacDerechoI02[];
