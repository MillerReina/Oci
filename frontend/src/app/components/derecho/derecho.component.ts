...
import { FacDerechoI01 } from 'src/app/models/fac-derecho-i01';
...
export class DerechoComponent implements OnInit {
  ...
  constructor(public zone : NgZone,public service : ServiceService) { 
    this.preload = true;
    this.service.getFacDerechoI01()
          .subscribe(res=>{
             this.service.facDerI01Array = res as FacDerechoI01[];
             this.countAnios();
             this.preload = false;             
          });
  }
  ...
  countAnios(){
    const array =  this.service.facDerI01Array as FacDerechoI01[];
